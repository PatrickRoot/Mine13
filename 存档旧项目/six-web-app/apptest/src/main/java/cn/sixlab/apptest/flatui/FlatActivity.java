package cn.sixlab.apptest.flatui;
...
import cn.sixlab.apptest.R;

public class FlatActivity extends ActionBarActivity {

    private final int APP_THEME = R.array.blood;

    private ArrayList<FlatTextView> flatTextViews = new ArrayList<>();
    private ArrayList<FlatEditText> flatEditTexts = new ArrayList<>();
    private ArrayList<FlatButton> flatButtons = new ArrayList<>();
    private ArrayList<FlatCheckBox> flatCheckBoxes = new ArrayList<>();
    private ArrayList<FlatRadioButton> flatRadioButtons = new ArrayList<>();
    private ArrayList<FlatToggleButton> flatToggleButtons = new ArrayList<>();
