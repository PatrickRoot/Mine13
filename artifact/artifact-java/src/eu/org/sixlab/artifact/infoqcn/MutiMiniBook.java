...
public class MutiMiniBook {
    ...
    private static final String USERNAME = "nianqinianyi@163.com";
    private static final String PASSWORD = "shikbg6six";
        ...
        try {
            ...
            for (Element span : spans) {
                onclick_str = span
                        ...
                        .replace(
                                "');UserActions_Login.showLoginWidget(this,'minibookDownload');",
                                "");
                download_link = DOMAIN + onclick_str;
                download_link.replace(" ", "%20");
                break;
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static synchronized String login(String username, String password) {
        ...
        String loginUrl = "https://www.infoq.com/cn/login.action?"
    ...
    public static void main(String[] args) throws InterruptedException {
            ...
            executor.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    if (download_url != null) {
                        System.out
                                .println("download started : " + download_url);
        ...
        executor.shutdown();
        System.out.println("download completed: " + result.getSuc()
                + " success," + result.getFail() + " failed.");
